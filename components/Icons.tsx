...
export const CheckCircleIcon = ({className = "h-5 w-5 text-teal-500 dark:text-teal-400"}: {className?: string}) => (
...
export const ArchiveIcon = ({className = "h-5 w-5"}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const DocumentTextIcon = ({className = "h-5 w-5"}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const MicrophoneIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7 7 0 01-14 0m14 0a7 7 0 11-14 0m14 0v4a1 1 0 01-1 1h-2a1 1 0 01-1-1v-4M7 11v4a1 1 0 001 1h2a1 1 0 001-1v-4" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 17v4m0 0H9m3 0h3" />
  </svg>
);

export const ViewGridIcon = ({className = "h-5 w-5"}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ExclamationTriangleIcon = ({className = "h-6 w-6"}: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const BoldIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path d="M9.25 5a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5z" />
    <path fillRule="evenodd" d="M6 3.75A2.75 2.75 0 018.75 1h2.5A2.75 2.75 0 0114 3.75v10.5A2.75 2.75 0 0111.25 17h-2.5A2.75 2.75 0 016 14.25V3.75zM7.5 6.5h2a1 1 0 000-2h-2V3.75a1.25 1.25 0 011.25-1.25h2.5A1.25 1.25 0 0112.5 3.75v2.5h-2.25a.75.75 0 000 1.5h2.25V9h-2a1 1 0 100 2h2v1.25a1.25 1.25 0 01-1.25-1.25h-2.5A1.25 1.25 0 017.5 12.25V9.75h2.25a.75.75 0 000-1.5H7.5V6.5z" clipRule="evenodd" />
  </svg>
);

export const StrikethroughIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M15.313 4.219a.75.75 0 01.284 1.031l-3.5 6.5a.75.75 0 01-1.314-.701l3.5-6.5a.75.75 0 011.03-.33zM4.687 15.781a.75.75 0 01-.284-1.031l3.5-6.5a.75.75 0 011.314.701l-3.5 6.5a.75.75 0 01-1.03.33z" clipRule="evenodd" />
...
export const ListBulletIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M2 5.75A.75.75 0 012.75 5h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 5.75zM2 10.75A.75.75 0 012.75 10h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75zM2 15.75A.75.75 0 012.75 15h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 15.75z" clipRule="evenodd" />
  </svg>
);

export const SunIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M12 12a4 4 0 100-8 4 4 0 000 8z" />
  </svg>
);
...
export const RestoreIcon = ({className = "h-5 w-5"}: {className?: string}) => (
